...
export default function LeaderBoard() {
	...
	return (
		<div className="flex w-fit flex-col gap-0.5 rounded-lg border border-[#c9a95d] bg-[#0a0a0a] p-2 shadow-md">
...
const TableHeaders = () => {
	...
	return (
		<div
			className="grid items-center gap-2 p-1 px-2 text-sm font-semibold text-[#c9a95d]"
			style={{
